        ...
        if (!supportedFormats.includes(format) && !layer.options.mimetype) {
            ...
            return fetcher[format](layer.url).then((file) => {
                ...
                if (layer.options.mimetype === 'vector/geojson') {
                    layer.feature = GeoJSON2Feature.parse(layer.reprojection, file, layer.extent, options);
                    ...
                    layer.feature = GeoJSON2Feature.parse(layer.reprojection, geojson, layer.extent, options);
